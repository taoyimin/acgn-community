package com.taozi.twodimension.modules.novel.adatper;
 ...
 */
public class ChapterRecyclerViewAdapter extends RecyclerView.Adapter<ChapterRecyclerViewAdapter.GridViewHolder>{
    Context context;
    Integer episode;
    OnItemClickListener onItemClickListener;

    public ChapterRecyclerViewAdapter(Context context, Integer episode) {
